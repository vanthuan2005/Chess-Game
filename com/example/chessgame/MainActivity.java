...
public class MainActivity extends AppCompatActivity {
    ...
    private ChessSoundManager sound;
            ...
            new Runnable() {
                ...
                public void run() {
                    ...
                    if (chessGame != null &&
                        ...
                        sound.checkTenSeconds(whiteTimeMs, blackTimeMs);
                        updateTimerViews();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound = new ChessSoundManager(this);
        ...
        chessGame.setEnPassantState(whitePassant, blackPassant);
    ...
    public void buildGuiByCode() {
        ...
        boardRenderer = new ChessBoardRenderer(this, buttons, game, chessGame);
        boardRenderer.resetButtons();
    ...
    private void syncEnPassantState() {
        chessGame.setEnPassantState(whitePassant, blackPassant);
    }

    private void expireEnPassantForMovingSide(int side) {
        for (int i = 0; i < Chess.SIDE; i++) {
            if (side == 1 && whitePassant[i] == 1) {
                whitePassant[i] = 2;
            }

            if (side == 2 && blackPassant[i] == 1) {
                blackPassant[i] = 2;
            }
        }
    }
    ...
    public void update(
        ...
        int moveSound = ChessSoundManager.MOVE_NONE;
        int movingSide = chessGame.getTurn();
        ...
        if (currentGreen != null &&
            ...
            if (currentGreen[row][col] == 2) {
                ...
                expireEnPassantForMovingSide(movingSide);
                ...
                moveCompleted = true;
                moveSound = ChessSoundManager.MOVE_NORMAL;
            }
            ...
            // ---------------------------------
                ...
                expireEnPassantForMovingSide(chessGame.getTurn());
                syncEnPassantState();
                ...
                moveCompleted = true;
                moveSound = ChessSoundManager.MOVE_CAPTURE;
            }
            ...
            // ---------------------------------
                ...
                moveCompleted = true;
                moveSound = ChessSoundManager.MOVE_CASTLE;
            }
        ...
        sound.playMove(moveSound, movingSide, chessGame);
    ...
    private void undoMove() {
        ...
        game = chessGame.getGame();
        if (boardRenderer != null) boardRenderer.setGame(game);
        ...
        timerRunning = true;
        sound.syncClock(whiteTimeMs, blackTimeMs);
        restartTimerLoop();
    ...
    private void onTimeOut(
        ...
        sound.playGameResult(blackLost ? 2 : 1);
        ...
        alert.setItems(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(
                        ...
                        chessGame.recordCurrentPosition();
                        sound.playMove(ChessSoundManager.MOVE_PROMOTE, white ? 1 : 2, chessGame);
    ...
    public void highlightCheckedKing() {
        if (boardRenderer != null) boardRenderer.highlightCheckedKing();
    }
    ...
    public void resetButtons() {
        if (boardRenderer != null) boardRenderer.resetButtons();
    }

    public void enableButtons(boolean enabled) {
        if (boardRenderer != null) boardRenderer.enableButtons(enabled);
    }

    public void resetBackgrounds() {
        if (boardRenderer != null) boardRenderer.resetBackgrounds();
    }

    public void movePieces(int row, int col) {
        if (boardRenderer != null) boardRenderer.movePiece(row, col);
    }
